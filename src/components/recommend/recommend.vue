                ...
                <!-- <div class="slider-wrapper" ref="sliderWrapper">
                    <slider>
                        <div v-for="item in sliderRecommends" v-bind:key="item.id" v-on:click="selectItem(item)">
                            <a>
                                <img v-bind:src="item.cover" alt="" height="250">
                            </a>
                        </div>
                    </slider>
                </div> -->
...
<script>
    ...
    export default {
        ...
        beforeCreate() {
            axios.get("http://119.45.124.76/api/getRecommendData").then((data) => {
        ...
        methods:{
            ...
            selectItem(item){
                axios.get(`http://119.45.124.76/api/getRecommendDetailData/${item.id}`).then((data)=>{
