    ...
    export default {
        ...
        watch: {
            currentSong(newSong, oldSong) {
                ...
                axios.post("http://119.45.124.76/api/getSongDetailData", JSON.stringify(data)).then((data) => {
            ...
            songData() {
                ...
                axios.post("http://119.45.124.76/api/getLyric", JSON.stringify(data)).then((data) => {
